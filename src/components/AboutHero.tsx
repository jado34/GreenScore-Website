    ...
    <section className="relative w-full min-h-screen flex flex-col lg:flex-row items-center justify-center px-6 lg:px-24 pt-32 lg:pt-0 overflow-hidden">
      ...
      >
        ...
        <p className="text-text-md sm:text-text-lg text-foreground/60 mb-10 md:mb-12 font-light leading-relaxed text-pretty lg:max-w-xl">
          We are Team 10, a passionate group of students from the <strong>Dev and Design Bootcamp</strong>. We are united by a single vision: to gamify and reward real-world environmental impact. From <strong>Seedling</strong> to <strong>Forest</strong>, track your journey with science-backed metrics.
        </p>
      </motion.div>
